...
/** Aether's orbital mark. */
export function Logo({ size = 22, className }: { size?: number; className?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      <ellipse cx="12" cy="12" rx="10" ry="4.4" stroke="currentColor" strokeWidth="1.4" transform="rotate(-24 12 12)" opacity="0.55" />
      <circle cx="12" cy="12" r="3.1" fill="currentColor" />
      <circle cx="20.2" cy="7.4" r="1.3" fill="currentColor" opacity="0.9" />
    </svg>
  );
}
...
const paths: Record<string, React.ReactNode> = {
  ...
  wifiOff: (
    <>
      <path d="M2 8.6a15 15 0 0 1 6.2-3.6M10.9 5.2A15 15 0 0 1 22 8.6M5 12.6a10 10 0 0 1 4.2-2.4M16.6 10.6a10 10 0 0 1 2.4 2M8.5 16.6a5 5 0 0 1 5.2-1.1" />
